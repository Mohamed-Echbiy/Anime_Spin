  ...
  return (
    <main class="min-h-screen w-full gap-y-7 text-xs md:text-sm lg:text-base  flex flex-col items-center justify-center hero">
      ...
      <p class="intro px-6 max-w-3xl">
        ...
        thrilling surprises. Leave the tedious search behind and let fate guide
        your anime experience. With each spin, Anime Spin will randomly select
        an anime title, introducing you to captivating storylines and
        unforgettable characters. Embrace the unexpected and embark on a journey
        of anime discovery like never before. Get ready to spin, watch, and
        explore the world of anime in a whole new way. Welcome to Anime Spin,
